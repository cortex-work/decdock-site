      ...
      <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-[14px]">
        ...
        <nav className="hidden items-center gap-6 sm:flex" aria-label="Ana navigasyon">
          ...
          <a
            ...
            className="btn-primary ml-2 py-2 px-4 text-[0.75rem]"
          >
        ...
        <Dialog.Root open={open} onOpenChange={setOpen}>
          ...
          <Dialog.Portal>
            ...
            />
            <Dialog.Content
              className="fixed right-0 top-0 bottom-0 z-[101] w-[78vw] max-w-[320px] bg-[var(--page)] shadow-[−2px_0_40px_rgba(40,32,24,0.18)] p-8 flex flex-col"
            ...
            >
              ...
              <div className="mb-8 flex items-center justify-between">
                ...
                <Dialog.Close asChild>
                  <button className="flex h-8 w-8 items-center justify-center text-[var(--text-muted)] hover:text-[var(--text-strong)]" aria-label="Kapat">
              ...
              <nav className="flex flex-col gap-1" aria-label="Mobil navigasyon">
                {links.map((l) => (
                  <a
                    ...
                    className="rounded-[3px] px-3 py-3 text-[15px] font-medium text-[var(--text-body)] hover:bg-[rgba(161,118,78,0.08)] hover:text-[var(--text-strong)] transition-colors"
                  >
                    {l.label}
                  </a>
                ))}
